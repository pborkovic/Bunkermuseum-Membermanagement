...
/**
 * Route configuration for the password reset view.
...
/**
 * ResetPasswordView component - Password reset page.
 *
 * Reached via the link in the "forgot password" email. Allows a user to choose a
 * new password using a single-use, time-limited token received via email. Reuses
 * the same token-backed endpoint as the initial password setup.
 *
 * Features:
 * - Token-based password reset (token read from the URL)
 ...
 *
 * @component
 * @returns {JSX.Element} The password reset view
 *
...
export default function ResetPasswordView(): JSX.Element {
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      const response = await AuthController.resetPassword(token, password);
      ...
      <div className="flex min-h-screen w-full items-center justify-center p-4">
        <div className="w-full max-w-md space-y-6 text-center">
          <div className="flex flex-col items-center space-y-4">
            ...
            <h1 className="text-2xl font-bold text-black">Passwort erfolgreich zurückgesetzt!</h1>
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex flex-col items-center space-y-2 text-center">
          <img
            ...
            className="h-16 w-auto object-contain mb-2"
          />
          <h1 className="text-2xl font-bold text-black">Passwort zurücksetzen</h1>
          <p className="text-sm text-muted-foreground">
            Bitte wählen Sie ein neues, sicheres Passwort für Ihr Konto
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {isLoading ? 'Passwort wird zurückgesetzt...' : 'Passwort zurücksetzen'}
          </Button>
        </form>
